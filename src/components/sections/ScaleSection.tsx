    ...
    <>
      ...
      >
        ...
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-1/2 hidden w-[480px] -translate-x-1/2 -translate-y-1/2 opacity-[0.12] sm:block lg:w-[640px]"
        />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              Get the Scale Framework for $9.99
            </a>
          </div>
