...
export function FrameworkSection() {
  ...
  return (
    <>
      ...
      <section
        className="relative overflow-hidden bg-white f-section"
        aria-label="Core framework"
      >
        {/* Watermark — large, low-opacity "7" mark from the book branding */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/assets/seven-logo-sd87fsdf-1024x887.webp"
          alt=""
          aria-hidden="true"
          className="pointer-events-none absolute -right-24 top-1/2 hidden w-[420px] -translate-y-1/2 opacity-[0.06] sm:block lg:w-[560px]"
        />
